# -*- encoding: utf-8 -*-
# stub: debase-ruby_core_source 0.10.10 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/ruby-debug/debase-ruby_core_source".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<archive-tar-minitar>.freeze, ["~> 0.8"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 0.9.2"])
      s.add_development_dependency(%q<minitar-cli>.freeze, ["~> 0.8"])
    else
      s.add_dependency(%q<archive-tar-minitar>.freeze, ["~> 0.8"])
