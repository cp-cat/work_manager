# -*- encoding: utf-8 -*-
# stub: rest-client 1.7.3 x64-mingw32 lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rdoc>.freeze, [">= 2.4.2", "< 5.0"])
      ...
      s.add_dependency(%q<rdoc>.freeze, [">= 2.4.2", "< 5.0"])
      s.add_dependency(%q<mime-types>.freeze, [">= 1.16", "< 3.0"])
